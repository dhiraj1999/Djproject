...
<div class="container-fluid" style="width:auto">
    ...
    <div class="sign" style=" background-color:#192965" ><br /><br /><br /><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<u>SIGN IN</u><br />&nbsp; <br />

    <div class="input">
        <asp:Label ID="lbl1" runat="server" Text="USERNAME"></asp:Label>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*" ControlToValidate="txtuser" ForeColor="red"></asp:RequiredFieldValidator>
        <asp:TextBox ID="txtuser" runat="server" class="form-control" BorderColor="black"></asp:TextBox>
        <br />
    ...
    <asp:Button ID="btnsign" runat="server" Text="SIGN IN" class="form-control" style="background-color:#F39C12" /><br />
