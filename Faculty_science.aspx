...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">	
  ...
  <div>
      <h1 class="jumbotron text-center" style="background-color:#6ba8a9">Faculty of Science</h1>
  </div>	
    ...
    <div class="container-fluid">
        <h2 class="mumbai" style="color:white">Mumbai University Courses - UG/PG Courses under Faculty of Science</h2>
    ...
    <tbody>
     ...
     <h2 class="mumbai" style="color:white">Mumbai University Courses - Diploma/Certificate and PG Diploma Courses (Faculty of Science)</h2>
   <table class="table table-bordered table-hover" style="font-family:Verdana">
      <thead>
         <tr>
          <th>S.No.</th>
