...
<div>
    <h1 style="background-color:#F4D03F">College Profile </h1>
    <p style="font-family: Verdana, Geneva, Tahoma, sans-serif" class="bg-info"> <br />
        <asp:Image ID="Image1" runat="server" class="center-block rounded" ImageUrl="~/Image/vartak.jpg" Height="300px" Width="700px" /> 
        <br /><br />
 ...
 It encourages students to excel not only in academics but also in co-curricular activities thus making them fully rounded personalities able to face the challenges of the world.<br />
        &nbsp;&nbsp;&nbsp;&nbsp; College is affiliated to the <mark>University of Mumbai</mark>.There are more than <mark>7000 students.</mark> The college has appointed well qualified <mark>experienced teachers</mark>.There are well-equipped laboratories for all Science subjects including computers. <br />
 ...
 <br /><br />
        <asp:Image ID="Image2" runat="server" class="center-block rounded" Height="300px" ImageUrl="~/Image/vartak1.jpg"  Width="700px" />
        <br /><br />
