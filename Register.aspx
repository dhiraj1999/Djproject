...
<div class="container-fluid">
    ...
    <div class="input">
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ErrorMessage="*" Display = "Dynamic" ControlToValidate="txtuserid" ForeColor="red"></asp:RequiredFieldValidator>
        <asp:TextBox ID="txtuserid" runat="server" class="form-control" BorderColor="black" TextMode="Number" ></asp:TextBox>
        <br />
