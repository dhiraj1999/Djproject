...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">	
  ...
  <div>
      <h1 class="jumbotron text-center" style="background-color:#6ba8a9">Faculty of Commerce</h1>
  </div>	
     <div style="color:#43ab92">
        <p style="font-family:Verdana; text-align: justify;">It’s a 3 years full time undergraduate course & 2 years full time post-graduate course, affiliated to University of Mumbai.<br />
    ...
    <div class="container-fluid">
        <h2 class="mumbai" style="color:white">Mumbai University Courses  - UG/PG Programmes under Faculty of Commerce</h2>
    ...
    <tbody>
     ...
     <h2 class="mumbai" style="color:white">Mumbai University Courses - Certificate/Diploma and PG Diploma Courses (Faculty of Commerce)</h2>
   <table class="table table-bordered table-hover" style="font-family:Verdana">
      <thead>
         <tr>
          <th>S.No.</th>
